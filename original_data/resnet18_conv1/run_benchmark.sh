#!/bin/bash
#$ -cwd
#$ -o /home/basti/data/hdd/test/cnn_asip/core/apps/benchmark_conv2d/sge_logs/ssd_test____resnet18_conv1.log
#$ -j y
#$ -l h_vmem=8G
#$ -l num_proc=1
#$ -l vcs_mx=1
...
density=0.70
clock=1.90
appdir="/home/basti/data/hdd/test/cnn_asip/core/apps/benchmark_conv2d/runs/ssd_test/resnet18_conv1"
technode="tsmc28"
syn_prefix=""
compile_params=""
regen_inputs=False
run_name="ssd_test____resnet18_conv1"
vsize="16"
vlanes="16"
keep_rtl_saif=0
keep_rtl_dump=0
